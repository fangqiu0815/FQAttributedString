...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    FQAttributeString *builder = nil;
    
    switch (indexPath.row) {
        case 0:
        {
            builder = [[FQAttributeString alloc] initWithString:@"字体设置"];
        ...
        case 1:
        {
            builder = [[FQAttributeString alloc] initWithString:@"蓝色的背景红色的文字"];
        ...
        case 2:
        {
            builder = [[FQAttributeString alloc] initWithString:@"中间的文字中空"];
        ...
        case 3:
        {
            builder = [[FQAttributeString alloc] initWithString:@"删除线  和 下划线"];
        ...
        case 4:
        {
            builder = [[FQAttributeString alloc] initWithString:@"我有阴影"];
        ...
        case 5:
        {
            builder = [[FQAttributeString alloc] initWithString:@"我是胖子 和 我是廋子  和  我歪了"];
        ...
        case 6:
        {
            builder = [[FQAttributeString alloc] initWithString:@"看我的字间距越来越宽"];
        ...
        case 7:
        {
            ...
            builder = [[FQAttributeString alloc] initWithString:@"第一行\n第二行\n第三行\n"];
        ...
        case 8:
        {
            ...
            builder = [[FQAttributeString alloc] initWithString:@"文字\uFFFC混合排列"];
            builder.allRange.attachment = attach;
        }
            break;
        case 9:
        {
            builder = [[FQAttributeString alloc] initWithString:@"基线偏移的文字效果"];
        ...
        case 10:
        {
            builder = [[FQAttributeString alloc] initWithString:@"数字123是高亮的，456也是高亮的"];
        ...
        case 11:
        {
            ...
            builder = [[FQAttributeString alloc] initWithString:@"两只老虎，两只老虎 跑得快，跑得快"];
